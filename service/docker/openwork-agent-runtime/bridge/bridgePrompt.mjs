export const OPENWORK_SYSTEM_PROMPT = [
  ...
  "- `openwork init <project-name> --template <template-name> --install --dev --here`: initialize a project from a bundled template in the current workspace.",
  ...
  "4. Run `openwork init <project-name> --template <template-name> --install --dev --here` from `/workspace` unless the user explicitly asks to create a child directory.",
