    ...
    <div class="flex gap-5 h-full">
      ...
      <div class="flex-1 flex flex-col gap-4 min-w-0">
        ...
        <div class="h-20 flex justify-start">
          <div
            class="w-full h-full bg-white dark:bg-gray-800 rounded-lg shadow-md relative overflow-hidden"
          >
            <div class="p-4 flex flex-col justify-between h-full">
              <div class="flex justify-between items-center mb-2">
                <span class="text-sm font-medium text-gray-800 dark:text-gray-200">支持入口</span>
                <el-icon class="text-blue-500 text-lg"><ChatDotRound /></el-icon>
              </div>
              <div class="flex justify-between items-center">
                <span class="text-xs text-gray-600 dark:text-gray-400"
                  >部署时请替换为你的团队支持地址</span
                >
                <span class="text-xs text-blue-500 font-medium">模板占位</span>
              </div>
            </div>
          </div>
        </div>
